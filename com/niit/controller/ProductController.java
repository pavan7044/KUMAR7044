...
*/    //category and supplier services
	...
	@RequestMapping("/viewdetailsnormal")
	...
	return new ModelAndView("viewdetailsnormal", "product", product);
	}
...
public ModelAndView productViewDetails(@RequestParam("id") String id){
	System.out.println("Ima in viewdetails normal page");
	System.out.println("ID:" +id);
	int i= Integer.parseInt(id);
	Product product = productService.get(i);
	return new ModelAndView("viewdetailnormal", "product" , product);
